...
//import 'package:online_shop/Admin/adminShiftOrders.dart';
   ...
   displayAdminHomeScreen()
   {
     return Scaffold(
       appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: (){
              Route route = MaterialPageRoute(builder: (c) => Text("Clicked"));
              Navigator.pushReplacement(context,route);
            },
          ),
          actions: [
            FlatButton(
              child: Text("Logout",style:TextStyle(color:Colors.black,fontSize: 16.0),),
              onPressed: (){
    ...
    takeImage(mContext)
    {
      return showDialog(
        ...
        {
          return SimpleDialog(
            title: Text("ItemImage",style:TextStyle(color: Colors.pink,),),
            children: [
              SimpleDialogOption(
                child:Text("Capture with camera",style:TextStyle(color: Colors.pink,),),
                onPressed: capturePhotoWithCamera(),
              ),

              SimpleDialogOption(
                child:Text("select from gallery",style:TextStyle(color: Colors.pink,),),
    ...
    displayAdminUploadFormScreen()
    {
      return Scaffold(
        appBar: AppBar(
          ...
          title:Text("New Product",style:TextStyle(color:Colors.white,fontSize: 24.0),),
          actions:[
          FlatButton(
           onPressed: () => uploading ? null:() => uploadImageAndSaveItemInfo(),
           child:Text("Add ",style:TextStyle(color:Colors.pink,fontSize: 16.0),),
          ),
          ],
      ),
       body: ListView(
