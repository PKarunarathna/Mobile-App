          ...
          children: [
            ...
            Form(
               ...
               FlatButton.icon(
                  ...
                  label: Text("I'm an Admin", style:TextStyle(color:Colors.red,fontWeight: FontWeight.bold,)),
                ),
          ],
        ),
      ),
   ...
   FirebaseAuth _auth = FirebaseAuth.instance;
    void loginUser() async
    {
      showDialog(
        ...
        builder: (c)
        {
          return LoadingAlertDialog(message:"Auhenticating,please wait");
        }
        );
